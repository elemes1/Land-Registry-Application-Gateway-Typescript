 ...
 */
async function GetAllLands(contract: Contract): Promise<void> {
 ...
 */
async function CreateLandRecord(contract: Contract): Promise<void> {
 ...
 */
async function TransferLand(contract: Contract): Promise<void> {
...
async function SellLandRecord(contract: Contract): Promise<void> {
    console.log('\n--> Submit Transaction: TransferLand, transfers land ownership');
...
async function ReadLandRecord(contract: Contract): Promise<void> {
...
async function ReadAllBlocks(contract: Contract): Promise<void> {
 ...
 */
async function updateNonExistentLandRecord(contract: Contract): Promise<void>{
